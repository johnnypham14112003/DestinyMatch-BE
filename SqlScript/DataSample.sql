...
insert into [Account](Email,[Password],[Role],[Status]) values
	...
	('phuctoi8930@gmail.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	...
	('thuy.pham@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('tuan.ngo@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('lan.nguyen@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('danh.trinh@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('diem.le@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('bao.hoang@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('van.truong@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('duc.do@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('my.nguyen@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('tuan.le@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('phuong.tran@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('hai.ngo@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('thanh.nguyen@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('bao.tran@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('hong.le@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('minh.do@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced'),
	('nga.nguyen@example.com', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5', 'member', 'experienced');
go

insert into [Member](Fullname, Gender,Dob, AccountId, UniversityId, MajorId) values
	(N'Người Dùng', 1,		'2002-05-12',(select Id from [Account] where Email = 'user@example.com'),(select Id from [University] where Code = 'FPT'), (select Id from [Major] where Code = '7480103')),
	(N'Phúc Lê', 1,			'2003-05-12',(select Id from [Account] where Email = 'phuctoi8930@gmail.com'),(select Id from [University] where Code = 'FPT'), (select Id from [Major] where Code = '7480103')),
	(N'Nguyễn Văn An', 1,	'2001-09-18', (select Id from [Account] where Email = 'an.nguyen@example.com'), (select Id from [University] where Code = 'FPT'), (select Id from [Major] where Code = '7480103')),
	(N'Trần Thu Hà', 0,		'2004-03-07', (select Id from [Account] where Email = 'ha.tran@example.com'), (select Id from [University] where Code = 'NTT'), (select Id from [Major] where Code = '7340115')),
	(N'Lê Hoàng Minh', 1,	'2000-11-24',(select Id from [Account] where Email = 'minh.le@example.com'), (select Id from [University] where Code = 'QSX'), (select Id from [Major] where Code = '7480103')),
	(N'Phạm Thu Thủy', 0,	'2003-08-06',(select Id from [Account] where Email = 'thuy.pham@example.com'), (select Id from [University] where Code = 'QSX'), (select Id from [Major] where Code = '7340115')),
	(N'Ngô Đức Tuấn', 1,	'2002-02-15', (select Id from [Account] where Email = 'tuan.ngo@example.com'), (select Id from [University] where Code = 'FPT'), (select Id from [Major] where Code = '7480101')),
	(N'Nguyễn Thị Lan', 0,	'2001-10-09',(select Id from [Account] where Email = 'lan.nguyen@example.com'), (select Id from [University] where Code = 'QST'), (select Id from [Major] where Code = '7340101')),
	(N'Trịnh Công Danh', 1, '2004-01-23',(select Id from [Account] where Email = 'danh.trinh@example.com'), (select Id from [University] where Code = 'QST'), (select Id from [Major] where Code = '7480101')),
	(N'Lê Thị Diễm', 0,		'2003-04-11', (select Id from [Account] where Email = 'diem.le@example.com'), (select Id from [University] where Code = 'HCN'), (select Id from [Major] where Code = '7340101')),
	(N'Hoàng Quốc Bảo', 1,	'2000-12-28',(select Id from [Account] where Email = 'bao.hoang@example.com'), (select Id from [University] where Code = 'FPT'), (select Id from [Major] where Code = '7520130')),
	(N'Trương Thị Vân', 0,	'2002-07-05',(select Id from [Account] where Email = 'van.truong@example.com'), (select Id from [University] where Code = 'HCN'), (select Id from [Major] where Code = '7340201')),
	(N'Đỗ Minh Đức', 1,		'2001-06-21',(select Id from [Account] where Email = 'duc.do@example.com'), (select Id from [University] where Code = 'NTT'), (select Id from [Major] where Code = '7520130')),
	(N'Nguyễn Thị Mỹ', 0,	'2004-05-04',(select Id from [Account] where Email = 'my.nguyen@example.com'), (select Id from [University] where Code = 'DVL'), (select Id from [Major] where Code = '7340201')),
	(N'Lê Anh Tuấn', 1,		'2003-09-30',(select Id from [Account] where Email = 'tuan.le@example.com'), (select Id from [University] where Code = 'DVL'), (select Id from [Major] where Code = '7220209')),
	(N'Trần Thị Phương', 0, '2000-03-19',(select Id from [Account] where Email = 'phuong.tran@example.com'), (select Id from [University] where Code = 'VHS'), (select Id from [Major] where Code = '7220209')),
	(N'Ngô Văn Hải', 1,		'2002-08-27',(select Id from [Account] where Email = 'hai.ngo@example.com'), (select Id from [University] where Code = 'HIU'), (select Id from [Major] where Code = '7220209')),
	(N'Nguyễn Thị Thanh', 0,'2001-04-14',(select Id from [Account] where Email = 'thanh.nguyen@example.com'), (select Id from [University] where Code = 'VHS'), (select Id from [Major] where Code = '7510605')),
	(N'Trần Quốc Bảo', 1,	'2004-02-10',(select Id from [Account] where Email = 'bao.tran@example.com'), (select Id from [University] where Code = 'HIU'), (select Id from [Major] where Code = '7510605')),
	(N'Lê Thị Hồng', 0,		'2003-11-22',(select Id from [Account] where Email = 'hong.le@example.com'), (select Id from [University] where Code = 'HIU'), (select Id from [Major] where Code = '7520216')),
	(N'Đỗ Văn Minh', 1,		'2000-10-08',(select Id from [Account] where Email = 'minh.do@example.com'), (select Id from [University] where Code = 'UEF'), (select Id from [Major] where Code = '7520216')),
	(N'Nguyễn Thị Nga', 0,	'2002-01-16',(select Id from [Account] where Email = 'nga.nguyen@example.com'), (select Id from [University] where Code = 'UEF'), (select Id from [Major] where Code = '7340101'));
go
